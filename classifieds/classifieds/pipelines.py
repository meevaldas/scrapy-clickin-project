...
#         return cls(
#             mysql_host=crawler.settimgs.get("MYSQL_HOST"),
#             mysql_username=crawler.settimgs.get("MYSQL_USERNAME"),
#             mysql_password=crawler.settimgs.get("MYSQL_PASSWORD"),
#             mysql_database=crawler.settimgs.get("MYSQL_DATABASE")
#         )
#
...
#         )
#         self.cur.execute(
#             f"""CREATE TABLE IF NOT EXISTS {self.mysql_database}.classifieds(
...
#         adapter = ItemAdapter(item)
#         self.cur.execute(f"""
#             INSERT INTO {self.mysql_database}.classifieds (title,locality,address,landline,mobile,price)
#             VALUES (%s,%s,%s,%s,%s,%s)
#         """, (adapter.get("title", ""), adapter.get("locality", ""), adapter.get("address", ""),
#               adapter.get("landline", ""), adapter.get("mobile", ""), adapter.get("price", 0.0))
#                          )
#         self.conn.commit()
#         return item
